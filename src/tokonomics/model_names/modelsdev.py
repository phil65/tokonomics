...
ModelsDevModelId = Literal[
    ...
    "cloudflare-ai-gateway:workers-ai/aura-1",
    "cloudflare-ai-gateway:workers-ai/aura-2-en",
    "cloudflare-ai-gateway:workers-ai/aura-2-es",
    "cloudflare-ai-gateway:workers-ai/bge-base-en-v1.5",
    "cloudflare-ai-gateway:workers-ai/bge-large-en-v1.5",
    "cloudflare-ai-gateway:workers-ai/bge-m3",
    "cloudflare-ai-gateway:workers-ai/bge-small-en-v1.5",
    "cloudflare-ai-gateway:workers-ai/deepseek-r1-distill-qwen-32b",
    "cloudflare-ai-gateway:workers-ai/distilbert-sst-2-int8",
    "cloudflare-ai-gateway:workers-ai/gemma-sea-lion-v4-27b-it",
    "cloudflare-ai-gateway:workers-ai/gpt-oss-120b",
    "cloudflare-ai-gateway:workers-ai/gpt-oss-20b",
    "cloudflare-ai-gateway:workers-ai/granite-4.0-h-micro",
    "cloudflare-ai-gateway:workers-ai/indictrans2-en-indic-1B",
    "cloudflare-ai-gateway:workers-ai/llama-2-7b-chat-fp16",
    "cloudflare-ai-gateway:workers-ai/llama-3-8b-instruct",
    "cloudflare-ai-gateway:workers-ai/llama-3-8b-instruct-awq",
    "cloudflare-ai-gateway:workers-ai/llama-3.1-8b-instruct",
    "cloudflare-ai-gateway:workers-ai/llama-3.1-8b-instruct-awq",
    "cloudflare-ai-gateway:workers-ai/llama-3.1-8b-instruct-fp8",
    "cloudflare-ai-gateway:workers-ai/llama-3.2-11b-vision-instruct",
    "cloudflare-ai-gateway:workers-ai/llama-3.2-1b-instruct",
    "cloudflare-ai-gateway:workers-ai/llama-3.2-3b-instruct",
    "cloudflare-ai-gateway:workers-ai/llama-3.3-70b-instruct-fp8-fast",
    "cloudflare-ai-gateway:workers-ai/llama-guard-3-8b",
    "cloudflare-ai-gateway:workers-ai/m2m100-1.2b",
    "cloudflare-ai-gateway:workers-ai/melotts",
    "cloudflare-ai-gateway:workers-ai/mistral-7b-instruct-v0.1",
    "cloudflare-ai-gateway:workers-ai/nova-3",
    "cloudflare-ai-gateway:workers-ai/qwen3-30b-a3b-fp8",
    "cloudflare-ai-gateway:workers-ai/smart-turn-v2",
    "cloudflare-ai-gateway:workers-ai/whisper",
